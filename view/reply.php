...
<body topmargin=0 leftmargin=0 text=#464646>
  <center>
  <BR>
    <form action=../action/insert_reply.php method=post>
      <input type=hidden name=parent_DPT value=<?="$parent_row[DPT]"?>>
      <input type=hidden name=parent_THD value=<?="$parent_row[THD]"?>>
            ...
            <tr>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td align=left>
                    <INPUT type=text name=HL size=60 maxlength=35 value="<?=$parent_HL?>">
                    </td>
                  </tr>
                <tr>
                  <td width=60 align=left>내용</td>
                  <td align=left>
                    <TEXTAREA name=DESCR cols=65 rows=15 > <?=$parent_DESCR?></TEXTAREA>
                    </tr>
                  <tr>
